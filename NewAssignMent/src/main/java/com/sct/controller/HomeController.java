...
public class HomeController
{
    ...
    @PostMapping("/student")
    public String  addCourse(@RequestBody Student s)
    {
    	hsi.addStudent(s);
    ...
    {
    	List<Student>ls=hsi.getStudent();
    	return ls;
    }
    
	
	  @GetMapping("getDataByCourse") 
	  public List<Student> getDataByCourseId(int cid) {
	  List<Student>ls=hsi.getDataByCourse(cid); 
	  return ls; }
	 
    @DeleteMapping("/delete")
    public String deleteCoure(@PathVariable int cid)
    {
    	hsi.deleteCourse(cid);
    ...
    {
    	List<Student> ls2=hsi.getoneOrMoreCourse();
    	return ls2;
    }
}
